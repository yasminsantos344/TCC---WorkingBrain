...
<body>
    ...
    <section class="trilha">
        <h1><b>CONHEÇA OS 8 EIXOS<br>TEMÁTICOS DA REDAÇÃO</b></h1>
        <div class="container text-center">
          <div class="row">
            <div class="col order-first">
              <div class="col__1">
                <a href="../Aula01-Português/aula01_portugues.html"><img src="../Conteudos - Redação/assets/etapas/Etapa 1.svg" class="coluna__1_1"></a>
                <a href="#"><img src="../Conteudos - Redação/assets/etapas/Etapa 3.svg" class="coluna__1_2"></a>
                <a href="#"><img src="../Conteudos - Redação/assets/etapas/Etapa 5.svg" class="coluna__1_2"></a>
                <a href="#"><img src="../Conteudos - Redação/assets/etapas/Etapa 7.svg" class="coluna__1_2"></a>
              </div>
            </div>
            <div class="col">
              <div class="line">
            ...
            <div class="col order-last">
              <div class="col__2">
                <a href="#"><img src="../Conteudos - Redação/assets/etapas/Etapa 2.svg" class="coluna__2_1"></a>
                <a href="#"><img src="../Conteudos - Redação/assets/etapas/Etapa 4.svg" class="coluna__2_2"></a>
                <a href="#"><img src="../Conteudos - Redação/assets/etapas/Etapa 6.svg" class="coluna__2_2"></a>
                <a href="#"><img src="../Conteudos - Redação/assets/etapas/Etapa 8.svg" class="coluna__2_2"></a>
            </div>
          </div>
        </div>
    </section>
    <section class="progresso">
      <svg width="100%" height="100%" id="svg" viewBox="0 0 1440 490" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150"><path d="M 0,500 L 0,500 C 202.5,358 405,216 645,216 C 885,216 1162.5,358 1440,500 L 1440,500 L 0,500 Z" stroke="none" stroke-width="0" fill="#B2E8A6" fill-opacity="1" class="transition-all duration-300 ease-in-out delay-150 path-0" transform="rotate(-180 720 250)"></path></svg>
    </section>
    <footer>
      <div class="container">
        <div class="row">
          <img src="assets/brainbox-allblack.svg" style="width: 14rem;">
          <div class="col">
